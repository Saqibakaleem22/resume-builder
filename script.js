...
function updateFormFromResume() {
    ...
    document.getElementById("about").value = resumeAbout.textContent || '';
    ...
    document.getElementById("location").value = ((_d = resumeLocation.textContent) === null || _d === void 0 ? void 0 : _d.replace('location: ', '')) || '';
